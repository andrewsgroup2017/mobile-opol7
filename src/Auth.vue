...
<!-- eslint-disable-nextline -->
              <!-- <v-text-field prepend-icon="lock" name="password" id="password" label="Password" v-model="password" :append-icon="hidepw ? 'visibility' : 'visibility_off'" :append-icon-cb="() => (hidepw = !hidepw)" :type="hidepw ? 'password' : 'text'"hint="At least 6 characters" required></v-text-field> -->
            </v-form>
          </v-card-text>

          <v-card-actions>
            <v-spacer></v-spacer>
            <v-btn color="primary" @click="triggerSignIn">
              Log In
            </v-btn>
          </v-card-actions>
        </v-card>
